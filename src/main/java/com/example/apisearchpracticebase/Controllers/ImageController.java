...
public class ImageController {
    ...
    public ImageController() throws IOException {
        FileInputStream serviceAccount = new FileInputStream("/app/app.jar/!BOOT-INF/classes/!/src/main/resources/searchpracticebaseproject-firebase-adminsdk-60xwx-7514dc3fb5.json");
